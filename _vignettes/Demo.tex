...
Subsequently, as detailed above, we load the reference sgRNA library annotation, a we load and median normalise sgRNA counts for the EPLC-272H example cell line.
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-46-2} 
